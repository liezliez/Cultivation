...
<head>
    ...
    <title>Cultivation | Ayam Geprek Crisbar</title>
                ...
                <div class="col-lg-2">
                    <div class="header__logo">
                        <a href="./index.html">
                            ...
                            <img src="<?php echo base_url('/img/headerlogo.png'); ?>" alt="" height="40px">
                        </a>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                <li><a href="/pages/home.php">Homepage</a></li>
                                <li><a href="./blog.html">Tempat Kuliner</a></li>
                                <li class="active"><a href="./categories.html">Kategori <span class="arrow_carrot-down"></span></a>
                                    <ul class="dropdown">
