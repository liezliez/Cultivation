...
<div class="col-12">
    <div class="card text-white bg-dark">
        ...
        <!-- /.card-header -->
        <div class="col-9 card-body table-responsive p-0 ml-3">
        ...
        <div class="modal fade" id="delete<?= $value['id']; ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open('user/deleteUser/' . $value['id']) ?>
                    <div class="modal-body">
                        Apakah anda yakin ingin menghapus <b> <?= $value['username'] ?> </b> ?
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <a href="<?= base_url('user/deleteUser/' . $value['id']) ?>" class="btn btn-danger btn-sm">Delete</a>
                    </div>
                    <?php echo form_close() ?>
                </div>
                <!-- /.modal-content -->
